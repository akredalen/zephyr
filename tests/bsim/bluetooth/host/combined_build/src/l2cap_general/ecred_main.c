/* l2cap_ecred_main.c - Application main entry point */
...
#define LOG_MODULE_NAME main_l2cap_gen_ecred
...
static const struct bst_test_instance test_def[] = {
	{
		.test_id = "l2cap/general/ecred/peripheral",
		.test_descr = "Peripheral L2CAP ECRED",
		.test_main_f = test_peripheral_main
	},
	{
		.test_id = "l2cap/general/ecred/central",
...
struct bst_test_list *test_main_l2cap_general_ecred_install(struct bst_test_list *tests)
{
