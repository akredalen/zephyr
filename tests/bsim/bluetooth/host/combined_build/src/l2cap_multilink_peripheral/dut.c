...
LOG_MODULE_REGISTER(l2cap_mlp_dut, LOG_LEVEL_DBG);
...
void entrypoint_multilink_peripheral_dut(void)
{
	/* Test purpose:
	 *
	...
	TEST_START("multiplink peripheral dut");
	...
	TEST_PASS_AND_EXIT("multiplink peripheral dut");
}
